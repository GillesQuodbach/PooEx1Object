...
//		Person manu = new Person("Macron", "Emmanuel", 43, "Elysée Ã  Paris", new City("Amien", "France"));
...
//		personnalites.add(new Person("Macron", "Emmanuel", 43, "L'Elysée Ã  Paris", new City("Amien", "France")));
//		personnalites.add(new Person("Sarkozy", "Nicolas", 66, "Paris", new City("Paris", "France", 2000000)));
//		personnalites
//				.add(new Person("Johnson", "Boris", 56, "Downing Street Ã  London", new City("NewYork", "Etats-Unis")));
